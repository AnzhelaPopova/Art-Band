...
class ItcSlider {
  static CLASS_CONTROL = 'slider__control__rev';
  static CLASS_CONTROL_HIDE = 'slider__control_hide__rev';
  static SEL_WRAPPER = '.slider__wrapper__rev';
  static SEL_ITEM = '.slider__item__rev';
  static SEL_ITEMS = '.slider__items__rev';
  static SEL_PREV = '.slider__control__rev[data-slide="prev"]';
  static SEL_NEXT = '.slider__control__rev[data-slide="next"]';
  static TRANSITION_OFF = 'slider_disable-transition__rev';
  ...
  _balanceItems() {
    ...
    if (this._direction === 'next') {
      ...
      if (exItemRectRight < wrapperRect.left - targetWidth) {
        ...
        this._exItemMin.style.transform = `translate3D(${translate}px, 0, 0.1px)`;
      ...
      if (exItemRectLeft > wrapperRect.right + targetWidth) {
        ...
        this._exItemMax.style.transform = `translate3D(${translate}px, 0, 0.1px)`;
        this._updateExProperties();
      }
    }
    window.setTimeout(() => {
  ...
  _move() {
    ...
    this._elItems.style.transform = `translate3D(${transform}px, 0, 0.1px)`;
  ...
  _setInitialValues() {
    ...
    if (this._config.loop) {
      ...
      this._elsItem[lastIndex].style.transform = `translate3D(${translate}px, 0, 0.1px)`;
      this._updateExProperties();
  ...
  _reset() {
    ...
    this._elItems.style.transform = 'translate3D(0px, 0, 0.1px)';
    this._setInitialValues();
